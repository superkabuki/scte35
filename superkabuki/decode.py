...
def decode(stuff=None):
    ...
    # Hex Literal
    superkabuki.decode(0XFC301100000000000000FFFFFF0000004F253396)

    # Integer
    big_int = 1439737590925997869941740173214217318917816529814
    superkabuki.decode(big_int)

    # Mpegts File
    superkabuki.decode('/path/to/mpegts')

    # Mpegts HTTP/HTTPS Streams
    superkabuki.decode('https://futzu.com/xaa.ts')
