...
# The format for tests is a dict of { "test_name" : value to pass to superkabuki.decode}
ten_tests = {
...
def smoke(tests=None):
    """
    calls superkabuki.decode using the values in tests.
    The format for tests:
    { "test_name" : value to pass to superkabuki.decode}
    ...
    import superkabuki
    superkabuki.smoke_test(my_tests)
