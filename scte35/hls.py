...
from scte35 import Segment, Cue
...
[ Input ]
    ...
    scte35 hls takes an m3u8 URI as input.

    M3U8 formats supported:
        * master  ( When a master.m3u8 used,
                   scte35 hls parses the first rendition it finds )
        * rendition
...
[ SCTE-35 ]
    ...
    scte35 hls displays SCTE-35 Embedded Cues as well as SCTE-35 HLS Tags.
...
[ SCTE-35 Parsing Profiles ]
    ...
    * starts:            set which Segmentation Type IDs to use to start breaks.
    ...
    Edit the file as needed and then run scte35 hls.
...
[ Cool Features ]
    ...
    * scte35 hls can resume when started in the middle of an ad break.
...
[ Example Usage ]
	...
	* Show this help:   scte35 hls help

	* Generate a new hls.profile:   scte35 hls profile

	* parse an m3u8:    scte35 hls  https://example.com/out/master.m3u8
