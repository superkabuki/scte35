...
# The format for tests is a dict of { "test_name" : value to pass to fu.decode}
ten_tests = {
...
def smoke(tests=None):
    """
    calls fu.decode using the values in tests.
    The format for tests:
    { "test_name" : value to pass to fu.decode}
