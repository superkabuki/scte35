...
from splicefu import Segment, Cue
...
[ Input ]
    ...
    splicefu hls takes an m3u8 URI as input.

    M3U8 formats supported:
        * master  ( When a master.m3u8 used,
                   splicefu hls parses the first rendition it finds )
        * rendition
...
[ SCTE-35 ]
    ...
    splicefu hls displays SCTE-35 Embedded Cues as well as SCTE-35 HLS Tags.
...
[ SCTE-35 Parsing Profiles ]
    ...
    * starts:            set which Segmentation Type IDs to use to start breaks.
    ...
    Edit the file as needed and then run splicefu hls.
...
[ Cool Features ]
    ...
    * splicefu hls can resume when started in the middle of an ad break.
...
[ Example Usage ]
	...
	* Show this help:   splicefu hls help

	* Generate a new hls.profile:   splicefu hls profile

	* parse an m3u8:    splicefu hls  https://example.com/out/master.m3u8
